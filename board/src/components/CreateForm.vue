    ...
    <div class="form">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="long"
                ref="name" placeholder="이름을 입력하세요" v-model="form.name" />
        </div>
        <div class="form-group">
            <label>전화번호</label>
            <input type="text" name="tel" class="long"
                placeholder="전화번호를 입력하세요" v-model="form.tel" />
        </div>
        <div class="form-group">
            <label>주 소</label>
            <input type="text" name="address" class="long"
                placeholder="주소를 입력하세요" v-model="form.address" />
        </div>
        <div class="form-group">
            <div>&nbsp;</div>
            <input type="button" class="btn btn-primary" value="저 장" v-on:click="saveBtn" />
...
export default {
    ...
    methods: {
        saveBtn(){
            eventBus.$emit("insert",this.form);
        },
        cancelBtn(){
